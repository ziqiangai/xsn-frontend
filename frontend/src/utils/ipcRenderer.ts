...
const windowWithElectron = window as ElectronWindow
const Renderer = (windowWithElectron.require && windowWithElectron.require('electron')) || windowWithElectron.electron || {}
